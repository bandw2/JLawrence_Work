#I have worked on this Open Source code and have been able to understand the flow of the code. 

#Features I have added, are a revamped pAI, which is a Player inhabiting a PDA that is able to do things. Most Noteably is several new Software add ons and the ability to interact with most devices remotely.
#all other sections of the code are not made by me, but the communities of SS13.
...
#This is the Original part of the Readme
# baystation12
...
### GETTING THE CODE (the Original code)
...
### INSTALLATION (this part is still required)
