...
/obj/machinery/vending/pAI//used for pAI spawning
	desc = "Get all your pAI's TODAY!"
	icon_state = "pAI"
	products = list(/obj/item/device/paicard = 10)
	contraband = list(/obj/item/device/paicard/syndie = 3)
	premium = list(/obj/item/device/paicard/holo = 3)


/obj/machinery/vending/pAI/sec
	name = "Security pAI Emporium"

/obj/machinery/vending/pAI/med
	name = "Medical pAI Emporium"

/obj/machinery/vending/pAI/bar
	name = "Bar pAI Emporium"

/obj/machinery/vending/pAI/engi
	name = "Engineering pAI Emporium"

/obj/machinery/vending/pAI/arr
	name = "Arrivals pAI Emporium"
