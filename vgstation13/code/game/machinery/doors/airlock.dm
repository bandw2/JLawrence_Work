...
/obj/machinery/door/airlock/attack_ai(mob/user as mob)
	...
	else if (istype(user, /mob/living/silicon/pai))//bandw2 was here
		var/mob/living/silicon/pai/pai = user
		if(!src.canAIControl())
			user << "AI control has been disabled, you may not interact with this object.<br>"
		else
			var/mob/living/C = user.loc
			...
			if(H)
				if(check_access(H.get_active_hand()) || check_access(H.wear_id))
					if(src.secondsMainPowerLost > 0)
						...
						t1 += text("Main power is online.<br>\n")
					if(pai.emaged || pai.engi)
						if(src.secondsBackupPowerLost > 0)
							if((!src.isWireCut(AIRLOCK_WIRE_BACKUP_POWER1)) && (!src.isWireCut(AIRLOCK_WIRE_BACKUP_POWER2)))
								t1 += text("Backup power is offline for [] seconds.<br>\n", src.secondsBackupPowerLost)
							else
						...
						t1 += text("<br>Access Denied for Core Door Systems. <br>\n\red Engineering Access Required.<br><br>\n")
						...
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI disrupting ID scanner of Airlock at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI disrupting ID scanner of Airlock. Unable to pinpoint location.</b></font>"
				if(2)
					//disrupt main power
					if(src.secondsMainPowerLost == 0)
						src.loseMainPower()
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI disrupting Airlock power at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI disrupting Airlock power. Unable to pinpoint location.</b></font>"
					...
					if(src.secondsBackupPowerLost == 0)
						...
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI disrupting Airlock Backup power at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI disrupting Airlock Backup power. Unable to pinpoint location.</b></font>"
					...
					if(src.isWireCut(AIRLOCK_WIRE_DOOR_BOLTS))
						...
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI dropping Airlock bolts at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI dropping Airlock bolts. Unable to pinpoint location.</b></font>"
					...
					if (src.isWireCut(AIRLOCK_WIRE_SAFETY))
						...
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI Overriding Airlock Safety Protocols at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI Overriding Airlock Safety Protocols. Unable to pinpoint location.</b></font>"
						...
						if(src.arePowerSystemsOn())
							...
							if(istype(usr, /mob/living/silicon/pai))
								...
								if(!pai.silence)
									for(var/mob/living/silicon/ai/AI in player_list)
										if(T.loc)
											AI << "<font color = red><b>Network Alert: pAI Raising Airlock Bolts at [T.loc].</b></font>"
										else
											AI << "<font color = red><b>Network Alert: pAI Raising Airlock Bolts. Unable to pinpoint location.</b></font>"
					...
					if(src.isWireCut(AIRLOCK_WIRE_ELECTRIFY))
						...
						if(istype(usr, /mob/living/silicon/pai))
							...
							if(!pai.silence)
								for(var/mob/living/silicon/ai/AI in player_list)
									if(T.loc)
										AI << "<font color = red><b>Network Alert: pAI electrified Airlock at [T.loc].</b></font>"
									else
										AI << "<font color = red><b>Network Alert: pAI electrified Airlock. Unable to pinpoint location.</b></font>"
...
/obj/machinery/door/airlock/attackby(C as obj, mob/user as mob)
	...
	if((istype(C, /obj/item/weapon/weldingtool) && !( src.operating > 0 ) && src.density))
		...
		return src.attack_hand(user)
	else if(istype(C, /obj/item/device/paicard))	// -- TLE
		var/obj/item/device/paicard/card = C
		card.plugin(src, user)
